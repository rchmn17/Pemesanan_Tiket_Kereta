 ...
 * @author Umar
 */
public class VABayarFrame extends javax.swing.JFrame {

    /**
     * Creates new form VABayarFrame
     */
    public VABayarFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("No. Rekening User :");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VABayarFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VABayarFrame().setVisible(true);
            }
        });
    }
